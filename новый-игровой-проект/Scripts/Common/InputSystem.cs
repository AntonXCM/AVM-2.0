...
public partial class InputSystem : Node
{
    ...
    public static Vector2 GetHoryzontalVelocity(float speed = 1) => new Vector2(((keys.Contains("D") ? 1 : 0) - (keys.Contains("A") ? 1 : 0)) * (keys.Contains("W") || keys.Contains("S") ? speed * 2 : speed), 0);
